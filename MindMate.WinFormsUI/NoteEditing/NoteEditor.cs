...
/// !!!Important: Working with mshtml
/// It is tedious to work with COM methods as they often allow for variation in argument and return types by designating types as 'object'.
/// This has necessitated explicit casting of the values to coordinate with strongly typed variables in C#. 
/// If you compile by using the EmbedInteropTypes (C# Compiler Options) option, the introduction of the dynamic type enables you to treat the occurrences of object in COM signatures as if they were of type dynamic, and thereby to avoid much of the casting.
/// Reference: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/types/using-type-dynamic#com-interop
/// Reference: https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/compiler-options/inputs#embedinteroptypes

namespace MindMate.WinFormsUI.NoteEditing
{
    /// <summary>
    /// Note Editor is an Html Editor. 
    /// It should not have any dependency on Mind Mate functionality.
    /// </summary>
    public partial class NoteEditor : WebBrowser, IHTMLChangeSink, MsHtmlWrap.IHTMLEditDesigner, INoteEditor
    {
        ...
        public bool InsideTable => TableEditor.InsideTable();
